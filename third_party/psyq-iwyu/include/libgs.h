 ...
 * initialized using GsClearOT().<br>
 * org always points to the start of the ordering table. tag points to the element within the ordering table at
 * which drawing takes place.<br>
 * length sets the size of the ordering table, in values from 1-14. The actual ordering table size is 2**length (i.e.
 * a value of 14 indicates an array of 16384 GsOT_TAG items, while a value of 8 indicates an array of 256
 * GsOT_TAG items).<br>
 * length and org values should be set first. The other members are set by GsClearOt().<br>
...
typedef struct GsImage {
     ...
     * <li>0: 4-bit CLUT</li>
     * <li>1: 8-bit CLUT</li>
     * <li>2: 16-bit DIRECT</li>
     * <li>3: 24-bit DIRECT</li>
     * <li>4: Coexistence of multiple modes</li>
     * </ul>
     */
    unsigned long pmode;
 ...
 *  @param outpacketp Pointer to an address storing drawing commands
 */
 ...
 * @param im Pointer to TIM data
 * @param tim Pointer to an image Structure
 */
